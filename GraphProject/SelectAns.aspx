<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectAns.aspx.cs" Inherits="GraphProject.SelectAns" %>
...
&nbsp;
    ...
    <div style="position:fixed;margin-top:-540px;left:20%;">
        Enter Question to display: <asp:TextBox ID="txtQuestion" runat="server" Width="450"></asp:TextBox>
    </div>
    <div style="position:fixed;margin-top:-480px;left:36%;">
        ...
        <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn" onclick="btnClear_Click"
            OnClientClick="return confirm('Are you sure you want to clear selected questions?')" CausesValidation="false" />
        <asp:Button ID="btnNext" runat="server" Text="Submit" CssClass="btn" onclick="btnSubmit_Click" 
            OnClientClick="return confirm('Are you sure you want to set selected buttons as answers?')" />
    </div>
    </form>
</body>
</html>
