<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="GraphProject.Test" %>
...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
    ...
    <asp:Label ID="lblQName" runat="server" Text="" style="position:fixed;margin-top:5px;text-align:left;width:100%;left:20%;color:#93b745;font-size:18px;font-family:Comic Sans MS"></asp:Label>
    <div style="padding-top:20px;">
    <p>
    <span style=" padding-left:595px; position:fixed;">
        <asp:ImageButton ID="imgA" runat="server" ImageUrl="~/Image/A.jpg" OnClick="imgA_Click" 
            Width="65px" />
    &nbsp;</span></p>
    <p>
...
&nbsp;
    ...
    <div style="position:fixed;margin-top:-540px;left:20%;display:none;">
        Enter Question to display: <asp:TextBox ID="txtQuestion" runat="server" Width="450"></asp:TextBox>
    </div>
    <div style="position:fixed;margin-top:-480px;left:43%;">
        <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn" onclick="btnClear_Click"
            OnClientClick="return confirm('Are you sure you want to clear selected elements?')" CausesValidation="false" />
        <asp:Button ID="btnNext" runat="server" Text="Next" CssClass="btn" onclick="btnNext_Click" />
        <asp:Button ID="btnSubmit" runat="server" Text="End Test" CssClass="btn" onclick="btnSubmit_Click" OnClientClick="confirm('Are you sure you want to end test?')" />
    </div>
    </form>
</body>
</html>
